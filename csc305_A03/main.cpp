...
hitable *final(){
    ...
    for (int i= 0;i < nb; i++) {
     ...
     material *light = new diffuse_light( new constant_texture(vec3(3.5,3.5,3.5)) );
     ...
     int nx, ny, nn;
     unsigned char *tex_data = stbi_load("/Volumes/xinyuel/csc305/A01/csc305_A01/pink.png", &nx, &ny, &nn, 0);
     material *emat = new lambertian(new image_texture(tex_data, nx ,ny));
     list[l++] = new sphere(vec3(400, 200, 400), 100, emat);
     texture *pertext = new noise_texture(20);
...
hitable *two_perlin_spheres(){
    ...
    int nx,ny,nn;
    unsigned char *tex_data = stbi_load("/Volumes/xinyuel/csc305/A01/csc305_A01/red.jpeg",&nx,&ny,&nn,0);
    material *emat = new lambertian(new image_texture(tex_data,nx,ny));
